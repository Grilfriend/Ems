...
public class BaseDao {
    ...
    //需要生成mapper文件的sql语句
    private static String sql = "SELECT  bl.flowid,bl.dljid,bl.zcjid,bl.pdjid,bl.compid,bc.compname,bd.devname \n" +
            "    FROM base_flow bl \n" +
            "    JOIN base_company bc ON bl.compid=bc.compid JOIN base_device bd ON bc.compid=bd.compid;\n" +
            "    ";
    //主表
